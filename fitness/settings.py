...
SECRET_KEY = 'django-insecure-ku&%6agl02u!g(!e&p@3m1x#n0$_q())t5ru&5*bp1yi)ewzpe'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['gymmanagementsystem-2kso.onrender.com', 'localhost', '127.0.0.1']
...
# Media settings for file uploads (like images)
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') # Make sure BASE_DIR is defined

# Authentication settings for @login_required
LOGIN_URL = 'login' # Or whatever your login URL name is

# Messages storage (default is fine for most cases)
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # ✅ For static/style.css
]
